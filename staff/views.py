...
def staff_home(request):
    ...
    return render(
        request, "staff_template/staff_home_template.html",
...
def staff_take_attendance(request):
    ...
    return render(
        request, "staff_template/staff_take_attendance.html",
...
def staff_update_attendance(request):
    ...
    return render(
        request, "staff_template/staff_update_attendance.html",
...
def start_live_classroom_process(request):
    ...
    if checks:
        ...
        onlineClass = OnlineClassRoom(
            room_name=roomname, room_pwd=room_pwd, subject=subject_obj,
            session_years=session_obj, started_by=staff_obj, is_active=True
        )
        onlineClass.save()

    return render(
        request, "staff_template/live_class_room_start.html",
        {"username": request.user.username, "password": room_pwd,
         "roomid": roomname, "subject": subject_obj.subject_name, "session_year": session_obj}
        )
